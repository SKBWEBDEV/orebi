...
{/* ---------------------------------two number start------------------------------------------- */}
        ...
        <div>
          <div className="relative group bg-[url(./assets/table.png)] px-20 py-40 w-[300px] bg-no-repeat mt-4">
        <div className="absolute bottom-0 left-0 opacity-0   group-hover:opacity-100 group-hover:bottom-0 ">
            <div className="absolute bottom-0 left-0 w-[300px] bg-white 
                  opacity-0 translate-y-4 
                  group-hover:opacity-100 group-hover:translate-y-0
...
{/* ---------------------------------three number start------------------------------------------- */}
           ...
           <div>
            <div className="relative group bg-[url(./assets/head.png)] px-20 py-40 w-[300px] bg-no-repeat mt-4">
        <div className="absolute bottom-0 left-0 opacity-0   group-hover:opacity-100 group-hover:bottom-0 ">
            <div className="absolute bottom-0 left-0 w-[300px] bg-white 
                  opacity-0 translate-y-4 
                  group-hover:opacity-100 group-hover:translate-y-0
...
{/* ---------------------------------four number start------------------------------------------- */}
         ...
         <div>
            <div className="relative group bg-[url(./assets/sunglass.png)] px-20 py-40 w-[300px] bg-no-repeat mt-4">
        <div className="absolute bottom-0 left-0 opacity-0   group-hover:opacity-100 group-hover:bottom-0 ">
            <div className="absolute bottom-0 left-0 w-[300px] bg-white 
                  opacity-0 translate-y-4 
                  group-hover:opacity-100 group-hover:translate-y-0
